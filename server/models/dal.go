...
func (ir *InsertResult) LastInsertId() (string, error) {
...
func (b *Base) InsertIntoTable(tx *sqlx.Tx, data map[string]interface{}) (*InsertResult, error) {
	if b.table == "" {
...
func (b *Base) UpdateById(tx *sqlx.Tx, data map[string]interface{}, id string) (sql.Result, error) {
	var result sql.Result
